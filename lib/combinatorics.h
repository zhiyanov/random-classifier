...
std::vector<typename std::iterator_traits<IterA>::value_type> Residual(IterA from_begin,
                                                                       IterA from_end,
                                                                       IterB to_begin,
                                                                       IterB to_end);
...
// implementation
template <class Iter>
Combinations<Iter>::Combinations(Iter begin, Iter end, size_t size)
    : data_{begin, end}, size_{size} {
...
template <class Iter>
Permutations<Iter>::Permutations(Iter begin, Iter end, size_t size)
    : Combinations<Iter>(begin, end, size) {
